...
class WebkulWebsiteAddons(models.TransientModel):
    ...
    module_website_address_city = fields.Boolean(string="Website: Website Address City")
    module_odoo_captcha_login_lockdown = fields.Boolean(string="Website: Website Google reCAPTCHA")
